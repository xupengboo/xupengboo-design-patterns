...
| 过滤器模式                                                   | 概述                                                 |
| ------------------------------------------------------------ | ---------------------------------------------------- |
| [过滤器](https://github.com/xupengboo/design-patterns/tree/main/7.%E8%BF%87%E6%BB%A4%E5%99%A8%E6%A8%A1%E5%BC%8F/src/main/java/com/xupengboo) | 实现对集合的筛选和过滤，以对 Person类 人员过滤举例。 |
...
| 组合模式 | 概述                                                         |
| -------- | ------------------------------------------------------------ |
| 组合模式 | 以 文件系统 为例：叶子节点就是文件File，容器（复合节点）就是文件夹。 |
